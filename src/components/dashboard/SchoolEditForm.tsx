...
export default function SchoolEditForm({ school, onSuccess }: { school: School; onSuccess: (updatedSchool: School) => void }) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      masterId: school.masterId?.toString() || "",
    },
  });
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    console.log("Simulating school update with:", values);
    ...
    toast({
      title: "¡Escuela Actualizada! (Simulación)",
      description: `La escuela ${values.name} ha sido actualizada con éxito.`,
    });
